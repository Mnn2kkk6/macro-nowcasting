...
# ── CẤU HÌNH MATPLOTLIB CHUẨN (SỬA LỖI TREO CELL 1) ──────────────────────────
import matplotlib

# Kiểm tra tuyệt đối chính xác xem có đang chạy trong Jupyter Notebook không
if 'ipykernel' in sys.modules or 'IPython' in sys.modules:
    # Nếu đang ở trong Jupyter, GIỮ NGUYÊN backend mặc định để hiển thị được hình
    pass
else:
    # Nếu chạy bằng file script python thường qua Terminal, dùng Agg để lưu file ngầm
    matplotlib.use("Agg")
...
# ... (Các hàm compile_metrics, plot_predictions, plot_shap_summary ở phía dưới giữ nguyên như cũ) ...
...
def plot_predictions(result, title: str = "", save: bool = True):
    ...
    # Hiển thị plot nếu đang dùng Jupyter
